<script lang="ts">
	import { addToCart, removeFromCart, cartItems } from '$lib/stores/cart';
...
<div class="group rounded-md shadow-sm relative block overflow-hidden">
	...
	<div class="relative border border-gray-100 bg-white p-3 lg:p-4 md:p-4">
		...
		<button
			...
			class="block mt-2 w-full rounded bg-red-400 p-4 text-sm font-medium transition hover:scale-105"
		>
			Remove from Cart
		</button>
	</div>
